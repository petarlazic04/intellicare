...
#include <memory>
#include "../../src/widgets/RoomCard.h"
...
QT_MOC_LITERAL(3, 18, 7) // "roomIdx"

    },
    "RoomCard\0clicked\0\0roomIdx"
};
...
void RoomCard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoomCard::clicked)) {
                *result = 0;
                return;
            }
        }
